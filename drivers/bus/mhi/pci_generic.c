...
#define MHI_CHANNEL_CONFIG_UL(ch_num, ch_name, el_count, ev_ring, ee, db) \
	{						\
		.num = ch_num,				\
		.name = ch_name,			\
...
#define MHI_CHANNEL_CONFIG_DL(ch_num, ch_name, el_count, ev_ring, ee, db) \
	{						\
		.num = ch_num,				\
		.name = ch_name,			\
		.num_elements = el_count,		\
...
static const struct mhi_channel_config modem_qcom_v1_mhi_channels[] = {
	MHI_CHANNEL_CONFIG_UL(12, "MBIM", 4, 0, MHI_EE_AMSS, MHI_DB_BRST_DISABLE),
	MHI_CHANNEL_CONFIG_DL(13, "MBIM", 4, 0, MHI_EE_AMSS, MHI_DB_BRST_DISABLE),
	MHI_CHANNEL_CONFIG_UL(14, "QMI", 4, 0, MHI_EE_AMSS, MHI_DB_BRST_DISABLE),
	MHI_CHANNEL_CONFIG_DL(15, "QMI", 4, 0, MHI_EE_AMSS, MHI_DB_BRST_DISABLE),
	MHI_CHANNEL_CONFIG_UL(20, "IPCR", 8, 0, MHI_EE_AMSS, MHI_DB_BRST_DISABLE),
	MHI_CHANNEL_CONFIG_DL(21, "IPCR", 8, 0, MHI_EE_AMSS, MHI_DB_BRST_DISABLE),
	MHI_CHANNEL_CONFIG_UL(100, "IP_HW0", 256, 1, MHI_EE_AMSS, MHI_DB_BRST_DISABLE),
	MHI_CHANNEL_CONFIG_DL(101, "IP_HW0", 256, 2, MHI_EE_AMSS, MHI_DB_BRST_DISABLE),
};
...
static const struct mhi_channel_config modem_quectel_v1_mhi_channels[] = {
	MHI_CHANNEL_CONFIG_UL(0, "LOOPBACK", 16, 0, MHI_EE_AMSS, MHI_DB_BRST_DISABLE),
	MHI_CHANNEL_CONFIG_DL(1, "LOOPBACK", 16, 0, MHI_EE_AMSS, MHI_DB_BRST_DISABLE),
	MHI_CHANNEL_CONFIG_UL(2, "SAHARA", 16, 0, MHI_EE_SBL, MHI_DB_BRST_DISABLE),
	MHI_CHANNEL_CONFIG_DL(3, "SAHARA", 16, 0, MHI_EE_SBL, MHI_DB_BRST_DISABLE),
	MHI_CHANNEL_CONFIG_UL(4, "DIAG", 16, 0, MHI_EE_AMSS, MHI_DB_BRST_DISABLE),
...
static const struct mhi_pci_dev_info mhi_quectel_rm500_info = {
	.name = "quectel-rm500",
